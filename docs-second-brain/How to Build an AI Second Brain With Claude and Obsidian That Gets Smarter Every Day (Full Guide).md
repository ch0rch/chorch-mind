---
title: "How to Build an AI Second Brain With Claude and Obsidian That Gets Smarter Every Day (Full Guide)"
source: "https://x.com/undefinedKi/status/2068306794116501544"
author:
  - "[[@undefinedKi]]"
published: 2026-06-20
created: 2026-07-06
description: "Your best ideas are scattered across a dozen places right now. Notes apps. Browser tabs. Old chats with Claude that you closed and will neve..."
tags:
  - "clippings"
---
![Imagen](https://pbs.twimg.com/media/HLNZ4A8XcAIcsHw?format=jpg&name=large)
...
![Imagen](https://pbs.twimg.com/media/HLMtNWsWcAED4PE?format=jpg&name=large)

Obsidian Second Brain Graph View
...
Go to [claude.com/download](https://claude.com/download) in your browser and download the desktop app for your system (Windows or Mac). Run the installer and open the app.
...
Go to [obsidian.md](https://obsidian.md/) and download Obsidian. It is free. Install it and open it.
...
> claude mcp add-json obsidian-vault '{ "type": "stdio", "command": "uvx", "args": \["mcp-obsidian"\], "env": { "OBSIDIAN\_API\_KEY": "PASTE-YOUR-KEY-HERE", "OBSIDIAN\_HOST": "127.0.0.1", "OBSIDIAN\_PORT": "27124" } }'
